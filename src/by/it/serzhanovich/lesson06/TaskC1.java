...
public class TaskC1 {
    public static void main(String[] args) {
        ...
        Dog dog1=new Dog(scanner.nextInt(), scanner.nextInt(), scanner.nextInt(), scanner.nextDouble());
        Dog dog2=new Dog(scanner.nextInt(), scanner.nextInt(), scanner.nextInt(), scanner.nextDouble());
if(dog1.win(dog2))
